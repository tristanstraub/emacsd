...
#+begin_src emacs-lisp
  ...
  (defcustom ts/helm-sources '(helm-source-git-grep
                               helm-source-buffers-list helm-source-ido-virtual-buffers)
  ...
  (defun ts/helm-cmd-t ()
    ...
    (interactive)
    (setq direct-web/helm-cmd-t (helm-cmd-t-get-create-source (helm-cmd-t-root-data)))
    (let ((helm-ff-transformer-show-only-basename nil))
      (helm-other-buffer ts/helm-sources "*helm for direct-web*")))
